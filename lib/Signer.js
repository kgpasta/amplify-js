 ...
 */
var getClockSkewCorrectedDate = function (clock_correction) {
    var dt = new Date();
...
var Signer = /** @class */ (function () {
    ...
    */
    Signer.sign = function (request, access_info, service_info, clock_correction) {
        ...
        if (clock_correction === void 0) { clock_correction = 0; }
        request.headers = request.headers || {};
        // datetime string and date string
        var dt = getClockSkewCorrectedDate(clock_correction), dt_str = dt.toISOString().replace(/[:\-]|\.\d{3}/g, ''), d_str = dt_str.substr(0, 8);
        var url_info = url.parse(request.url);
