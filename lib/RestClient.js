...
*/
    ...
    RestClient.prototype._signed = function (params, credentials, isAllResponse) {
        ...
        var clockSkewOffset = this._shouldApplyClockSkewOffset
            ? this._clockSkewOffset
            : 0;
        var signed_params = core_1.Signer.sign(otherParams, creds, signerServiceInfo, clockSkewOffset);
    ...
    RestClient.prototype._handleSignatureError = function (response) {
        var errorCode = response.headers
        ...
        return (response.data &&
            ...
            response.data.message.toLowerCase().indexOf('signature expired') >= 0);
    };
    return RestClient;
}());
