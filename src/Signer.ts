 ...
 */
const getClockSkewCorrectedDate = function(clock_correction) {
	const dt = new Date();
...
export default class Signer {
    ...
    */
	static sign(request, access_info, service_info = null, clock_correction = 0) {
		request.headers = request.headers || {};

		// datetime string and date string
		const dt = getClockSkewCorrectedDate(clock_correction),
